/** Пути к бренд-ассетам из public/ (учитывают VITE_BASE_PATH для GitHub Pages) */
export const BRAND_LOGO_URL = `${import.meta.env.BASE_URL}images/Logo.png`;
export const SHAWERMA_ICON_URL = `${import.meta.env.BASE_URL}images/shawerma.png`;
